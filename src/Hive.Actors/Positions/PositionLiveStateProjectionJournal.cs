...
{
    public PositionLiveStateProjectionJournalEvent(
        long offset,
...
internal sealed class AkkaPositionLiveStateProjectionJournal :
    ...
    IDisposable
{
    ...
    public AkkaPositionLiveStateProjectionJournal(ActorSystem actorSystem)
    {
