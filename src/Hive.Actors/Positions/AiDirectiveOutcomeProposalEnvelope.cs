...
internal static class AiDirectiveOutcomeProposalEnvelope
{
        ...
        bool allowProgressReports = false)
    {
        ...
        var proposalConstraint = (evidenceContext, authorityContext) switch
        {
            (null, _) => OutcomeProposalConstraint.CreateOutputConstraint(
                allowProgressReports),
            ({ } evidence, null) => OutcomeProposalConstraint.CreateOutputConstraint(
                evidence,
                allowProgressReports),
            ({ } evidence, { } authority) =>
